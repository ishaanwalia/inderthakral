...
export const metadata: Metadata = {
  ...
  keywords: ["Inder Thakral", "Mohali real estate", "Chandigarh property", "Tricity land", "residential plots Mohali", "commercial showroom", "NRI investment", "premium land advisory"],
