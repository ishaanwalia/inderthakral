    ...
    <main style={{ background: "#000000", minHeight: "100vh", color: "#FFFFFF", fontFamily: "var(--font-sans)" }}>
      ...
      <section style={{ padding: "100px 48px" }} className="section-pad">
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px" }} className="about-grid-desktop">
            <div>
              <div style={{ position: "relative", borderRadius: "20px", overflow: "hidden", border: "1px solid rgba(255,255,255,0.06)", marginBottom: "32px" }} className="card-3d">
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2px" }}>
                {[
                  ...
                  <div key={i} className="service-card tap-glow" style={{ 
                    ...
                    <div style={{ color: "#00D4FF", fontSize: "26px", fontWeight: 700, marginBottom: "6px", fontFamily: "var(--font-mono)" }}>{stat.num}</div>
                    <div style={{ color: "rgba(255,255,255,0.3)", fontSize: "9px", letterSpacing: "2px", textTransform: "uppercase", fontFamily: "var(--font-mono)", fontWeight: 500 }}>{stat.label}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <p style={{ color: "#FFFFFF", fontSize: "20px", fontWeight: 600, lineHeight: 1.8, marginBottom: "28px", letterSpacing: "-0.5px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                  {[
                    ...
                    <div key={i} style={{ display: "flex", gap: "16px", alignItems: "flex-start" }}>
                      ...
                      <span style={{ color: "rgba(255,255,255,0.5)", fontSize: "14px", lineHeight: 1.6, fontWeight: 500 }}>{item}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.04)", paddingTop: "100px" }}>
            ...
            <h2 style={{ 
              ...
              Visit us in <span style={{ color: "#00D4FF", fontWeight: 700 }}>Mohali</span>
            </h2>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "2px" }} className="about-grid-desktop">
              <div style={{ position: "relative", overflow: "hidden", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.06)" }} className="card-3d tap-glow">
                <img
                  ...
                  style={{ width: "100%", height: "100%", aspectRatio: "4/3", objectFit: "cover", objectPosition: "center 35%", display: "block" }}
                />
                <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.75) 0%, transparent 40%)" }} />
                <div style={{ position: "absolute", bottom: "24px", left: "24px", right: "24px" }}>
                  <p style={{ color: "#00D4FF", fontSize: "10px", letterSpacing: "3px", textTransform: "uppercase", fontFamily: "var(--font-mono)", fontWeight: 500 }}>Our Showroom · Sector 108, Mohali</p>
                </div>
              </div>
              <div className="service-card tap-glow" style={{
                ...
                <div>
                  <p style={{ color: "#00D4FF", fontSize: "10px", letterSpacing: "4px", textTransform: "uppercase", fontFamily: "var(--font-mono)", marginBottom: "12px", fontWeight: 500 }}>Address</p>
                  <p style={{ color: "#FFFFFF", fontSize: "17px", fontWeight: 500, lineHeight: 1.7, letterSpacing: "0.3px" }}>
                ...
                <div>
                  <p style={{ color: "#00D4FF", fontSize: "10px", letterSpacing: "4px", textTransform: "uppercase", fontFamily: "var(--font-mono)", marginBottom: "12px", fontWeight: 500 }}>Contact</p>
                  <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "15px", lineHeight: 1.9 }}>
                    <a href="tel:+919815901234" className="hover-line" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none" }}>+91 98159 01234</a><br />
                    <a href="mailto:care@inderthakral.com" className="hover-line" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none" }}>care@inderthakral.com</a>
                  </p>
                </div>
                <a
      ...
      <section style={{ 
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ color: "#00D4FF", fontSize: "13px", letterSpacing: "3px", fontFamily: "var(--font-mono)", fontWeight: 500 }}>— Inder Thakral</p>
        </div>
      </section>
