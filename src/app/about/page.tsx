          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.04)", paddingTop: "100px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "2px" }}>
              <div className="service-card tap-glow" style={{ 
                ...
                <span style={{ color: "rgba(255,255,255,0.3)", fontSize: "11px", letterSpacing: "3px", textTransform: "uppercase", fontFamily: "var(--font-mono)", fontWeight: 500 }}>Office Photo Coming Soon</span>
              </div>
              <div className="service-card tap-glow" style={{ 
                aspectRatio: "4/3", 
                display: "flex", 
                ...
                <span style={{ color: "rgba(0,212,255,0.2)", fontSize: "36px" }}>◈</span>
                <span style={{ color: "rgba(255,255,255,0.3)", fontSize: "11px", letterSpacing: "3px", textTransform: "uppercase", fontFamily: "var(--font-mono)", fontWeight: 500 }}>Office Interior Coming Soon</span>
              </div>
            </div>
          </div>
        </div>
