    ...
    <main style={{ background: "var(--dark)", minHeight: "100vh" }}>
            ...
            <div key={i}>
              <div className="services-grid" style={{ direction: service.flip ? "rtl" : "ltr" }}>
                <div style={{ direction: "ltr" }}>
                  ...
                  <a href="/#contact" style={{ display: "inline-block", border: "1px solid var(--gold)", color: "var(--gold)", padding: "14px 32px", fontSize: "11px", letterSpacing: "3px", textTransform: "uppercase", textDecoration: "none", transition: "all 0.3s ease" }}>Enquire About This</a>
                </div>
                <div style={{ direction: "ltr" }}>
      ...
      <section style={{ padding: "80px 48px", background: "var(--dark-2)", borderTop: "1px solid rgba(201,168,76,0.1)" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
          ...
          <a href="/#contact" style={{ display: "inline-block", background: "var(--gold)", color: "var(--dark)", padding: "18px 48px", fontSize: "11px", letterSpacing: "4px", textTransform: "uppercase", textDecoration: "none", fontWeight: 600, transition: "all 0.3s ease" }}>Book a Consultation</a>
        </div>
      </section>
