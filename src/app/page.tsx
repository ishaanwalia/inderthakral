    ...
    <main style={{ background: "var(--dark)", minHeight: "100vh" }}>
        ...
        <div style={{ display: "flex", gap: "40px" }}>
          {["Properties", "About", "Services", "Contact"].map((item) => (
            <a key={item} href={`#${item.toLowerCase()}`} style={{
              color: "var(--text-muted)", fontSize: "11px", letterSpacing: "2px",
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: "linear-gradient(to bottom, rgba(10,10,10,0.5) 0%, rgba(10,10,10,0.7) 50%, rgba(10,10,10,1) 100%)",
        }} />
        <div style={{ position: "relative", textAlign: "center", padding: "0 24px" }}>
          <motion.p
            ...
            style={{ color: "var(--gold)", fontSize: "11px", letterSpacing: "6px", textTransform: "uppercase", marginBottom: "24px" }}
          >Chandigarh Tricity · Est. 2009</motion.p>
          <motion.h1
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.4 }}
            style={{ fontSize: "clamp(40px, 7vw, 96px)", fontWeight: 300, lineHeight: 1.05, marginBottom: "32px", letterSpacing: "-1px" }}
          >
            Verified Plots.<br />
          ...
          <motion.p
            ...
            style={{ color: "var(--text-muted)", fontSize: "16px", maxWidth: "480px", margin: "0 auto 48px", lineHeight: 1.8 }}
          >Independent real estate advisory across the Mohali expansion corridor. 100% verified title deeds. By appointment only.</motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <a href="#contact" style={{
              border: "1px solid rgba(201,168,76,0.4)", color: "var(--text-primary)",
              padding: "16px 40px", fontSize: "11px", letterSpacing: "3px",
              textTransform: "uppercase", textDecoration: "none",
              transition: "all 0.3s",
            }}>Book Consultation</a>
      ...
      <section style={{ padding: "80px 48px", borderTop: "1px solid rgba(201,168,76,0.1)", borderBottom: "1px solid rgba(201,168,76,0.1)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "40px", textAlign: "center" }}>
          {[
            { num: "₹450Cr+", label: "Transaction Volume" },
            { num: "100%", label: "Verified Title Deeds" },
            { num: "15+", label: "Years Local Expertise" },
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2px" }}>
            {[
              ...
              <motion.div
                ...
                whileHover={{ backgroundColor: "#161616", borderColor: "rgba(201,168,76,0.3)" }}
              >
                <div style={{ color: "var(--gold)", fontSize: "24px", marginBottom: "24px" }}>{service.icon}</div>
                <h3 style={{ fontSize: "20px", fontWeight: 300, marginBottom: "16px", letterSpacing: "0.5px" }}>{service.title}</h3>
      ...
      {/* ABOUT */}
      <section id="about" style={{ padding: "120px 48px", background: "var(--dark-2)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }}>
          ...
          >
            ...
            <p style={{ color: "var(--text-muted)", fontSize: "15px", lineHeight: 1.9, marginBottom: "24px" }}>Unlike transactional agencies or digital portals, Inder Thakral Properties operates on direct personal accountability. We analyze the micro-market growth of Mohali block by block so you buy with absolute confidence.</p>
            <p style={{ color: "var(--text-muted)", fontSize: "15px", lineHeight: 1.9, marginBottom: "48px" }}>Every transaction is personally managed by Inder Thakral, ensuring 100% verified title deeds and transparent valuations for high-net-worth investors.</p>
            <a href="#contact" style={{
              display: "inline-block",
              border: "1px solid var(--gold)", color: "var(--gold)",
              padding: "14px 36px", fontSize: "11px", letterSpacing: "3px",
              textTransform: "uppercase", textDecoration: "none",
              transition: "all 0.3s",
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2px", marginBottom: "64px" }}>
              {[
                { label: "Email", value: "care@inderthakral.com" },
                { label: "Phone", value: "+91 98159 01234" },
                { label: "Location", value: "Mohali, Tricity" },
              ].map((item, i) => (
            ...
            <a href="mailto:care@inderthakral.com" style={{
              display: "inline-block",
              background: "var(--gold)", color: "var(--dark)",
              padding: "18px 56px", fontSize: "11px", letterSpacing: "4px",
              textTransform: "uppercase", textDecoration: "none", fontWeight: 600,
            }}>Send Enquiry</a>
          </motion.div>
        </div>
