    ...
    <>
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: "rgba(10,10,10,0.97)", borderBottom: "1px solid rgba(201,168,76,0.1)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "18px 24px" }}>
          ...
          <button type="button" onClick={toggle} className="hamburger">
        ...
        {open && (
          <div className="mobile-dropdown">
            <Link href="/properties" onClick={() => setOpen(false)} style={{ color: "var(--text-muted)", fontSize: "15px", letterSpacing: "3px", textTransform: "uppercase", textDecoration: "none", display: "block", padding: "12px 0" }}>Properties</Link>
            <Link href="/about" onClick={() => setOpen(false)} style={{ color: "var(--text-muted)", fontSize: "15px", letterSpacing: "3px", textTransform: "uppercase", textDecoration: "none", display: "block", padding: "12px 0" }}>About</Link>
            <Link href="/services" onClick={() => setOpen(false)} style={{ color: "var(--text-muted)", fontSize: "15px", letterSpacing: "3px", textTransform: "uppercase", textDecoration: "none", display: "block", padding: "12px 0" }}>Services</Link>
            <a href="/#contact" onClick={() => setOpen(false)} style={{ color: "var(--text-muted)", fontSize: "15px", letterSpacing: "3px", textTransform: "uppercase", textDecoration: "none", display: "block", padding: "12px 0" }}>Contact</a>
            <a href="/#contact" onClick={() => setOpen(false)} style={{ display: "block", background: "var(--gold)", color: "var(--dark)", padding: "16px", fontSize: "12px", letterSpacing: "3px", textTransform: "uppercase", textDecoration: "none", textAlign: "center", fontWeight: 600, marginTop: "12px" }}>Enquire Now</a>
          </div>
        )}
      </nav>
    </>
